            ...
            func() {
                ...
                test(
                    ...
                    func() {
                        ...
                        assert (queryObj.keys == ["scope", "response_type"]);
                        assert (queryObj.get("scope") == ?"openid profile prometheus:charge");
                        assert (queryObj.get("response_type") == ?"code");
                    },
                );
                ...
                test(
                    ...
                    func() {
                        ...
                        assert (queryObj.keys == ["value", "other"]);
                        assert (queryObj.get("value") == ?"a%20b");
                        assert (queryObj.get("other") == ?"normal");
                    },
                );
                ...
                test(
                    ...
                    func() {
                        ...
                        assert (SearchParams(input).get("path") == expected);
                    },
                );
                ...
                test(
                    ...
                    func() {
                        assert (Utils.decodeURIComponent("invalid%2G") == ?"invalid%2G");
                        assert (Utils.decodeURIComponent("incomplete%F") == ?"incomplete%F");
                        assert (Utils.decodeURIComponent("trailing%") == ?"trailing%");
                    },
                );
            },
        );
            ...
            func() {
                test(
                    ...
                    func() {
                        ...
                        switch (body.file()) {
                            case (?buffer) assert Buffer.toArray(buffer) == jsonBytes;
                            case (null) assert false;
                        };

                        assert Buffer.toArray(bytes(9, 23)) == Iter.toArray<Nat8>(Array.slice(jsonBytes, 9, 23));
                    },
                );
                ...
                test(
                    ...
                    func() {
                        ...
                        assert Buffer.toArray(body.bytes(9, 23)) == Iter.toArray(Array.slice(bytes, 9, 23));
                    },
                );
                    ...
                    func() {
                        ...
                        switch (form.files("example.txt")) {
                            case (?arr) {
                                ...
                                assert file.end == 178;
                                assert Buffer.toArray(file.bytes) == Utils.textToBytes("value2");
                                assert Buffer.toArray(file.bytes) == Iter.toArray(Array.slice(blobArray, 172, 178));
                            };
                            case (_) assert false;
                        };
                    },
